...
const Scrollbar = (props: ScrollbarProps) => {
  ...
  const updateVerticalScrollbar = (
    ...
    const thumbLength = $contents.clientHeight * heightRatio;
  ...
  const updateHorizontalScrollbar = (
    ...
    const thumbLength = $contents.clientWidth * widthRatio;
  ...
  const handlePointerDown = (event: React.PointerEvent) => {
    ...
    const initialClientPosition = isHorizontal ? event.clientX : event.clientY;
  ...
  return (
    ...
    >
      <div ref={contentsRef} className={style.contents} onScroll={handleScroll}>
        {props.children}
      </div>
